...
- `ORDER-LIFECYCLE.md`
- `VIDEO-EA-ANALYSIS.md` — frame-derived PA zones, bounded stop-grid research, SET adaptation and safety differences
- `VIDEO-EA-VALIDATION.md` — deterministic replay, adverse-path, OOS, MetaTrader and Settrade UAT validation protocol
- `video-evidence/` — exact-media hashes and observation/inference evidence manifests
